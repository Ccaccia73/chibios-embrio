...
int sc_error(int number, char *message, char *filename, int firstline,
...
char* operator_symname(char *symname, char *opername, int tag1, int tag2, int numtags, int resulttag)
{
...
static constvalue* insert_constval(constvalue * prev, constvalue * next, char *name, cell val, short index)
{
	constvalue         *cur;
...
constvalue* append_constval(constvalue * table, char *name, cell val, short index)
{
	constvalue         *cur, *prev;
